...
/*a)Generar un archivo alumnosPP.dat que contiene la 
siguiente información correspondiente a los alumnos 
que cursan la materia Programación Procedural: Nombre, 
Numero de Registro y Resultado de un parcial 
(‘A’: Aprobado – ‘R’: Reprobado). La información se 
ingresa ordenada por Número de Registro.*/
typedef struct {
    char nombre[30];
    int registro;
    char nota;
